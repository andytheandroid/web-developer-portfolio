      ...
      <Navbar fluid={true}  style={ {margin: 0} }>
          ...
          <ul className="nav navbar-top-links navbar-right">
           ...
           <NavDropdown title={<span><i className="fa fa-tasks fa-fw"></i> </span>} id = 'navDropdown2222'>
                  ...
                  <MenuItem divider />
                  <MenuItem eventKey="5">
                    <div> <i className="fa fa-upload fa-fw"></i> Servidor reboteado <span className="pull-right text-muted small">4 minutes ago</span> </div>
                  </MenuItem>
                  <MenuItem divider />
                  <MenuItem eventKey="6">
           ...
           <NavDropdown title={<i className="fa fa-user fa-fw"></i> } id = 'navDropdown4'>
                  ...
                  <MenuItem eventKey="2">
                    <span><i className="fa fa-gear fa-fw"></i> Configuracion </span>
                  </MenuItem>
                  <MenuItem divider />
                  <MenuItem eventKey = "3" href = 'http://www.strapui.com' >
                    <span> <i className = "fa fa-eye fa-fw" /> Premium React Temasss </span>
                  </MenuItem>
                  <MenuItem divider />
